...
public class HotelsTest {
    ...
    public void whenTenHotels() {
        Hotels hotels = new Hotels(10, new ArrayList<>(Arrays.asList(60, 10, 30, 50, 11, 100, 40, 90, 70, 80)));
    ...
    public void whenFiveHotels() {
        Hotels hotels = new Hotels(5, new ArrayList<>(Arrays.asList(99, 2, 100, 50, 1)));
    ...
    public void whenFifteenHotels() {
        Hotels hotels = new Hotels(15, new ArrayList<>(Arrays.asList(6, 36, 60, 30, 100, 48, 12, 66, 78, 84, 24, 18, 72, 42, 54)));
